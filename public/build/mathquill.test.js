...
suite('typing with auto-replaces', function() {
  ...
  suite('CLASSS', function() {
    test('mathquill-basic-class', function() {
      var mq_basic = MQBasic.MathField($('<span></span>').appendTo('#mock')[0]);
      mq_basic.latex('\\class{e}{1}');
      mq_basic.typedText('+1');
      assert.equal(mq_basic.latex(), '\\class{e}{1}+1l');
    });
  });
